...
export const rolePermissions: Record<string, Permission[]> = {
  ...
  IT: [permissions.dashboardView, permissions.usersView, permissions.usersManage, permissions.departmentsView, permissions.assetsView, permissions.assetsManage, permissions.auditView],
